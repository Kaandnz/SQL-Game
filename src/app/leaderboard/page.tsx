...
export default function LeaderboardPage() {
  ...
  const ranks = [
    { name: "Junior Veri Analisti", range: "Lvl 1 - 3", icon: Award, color: "text-amber-500 bg-amber-500/10 border-amber-500/20" },
    { name: "Veri Analisti (Associate)", range: "Lvl 4 - 7", icon: Medal, color: "text-slate-300 bg-slate-500/10 border-slate-500/20" },
    { name: "Kıdemli Veri Mühendisi (Senior)", range: "Lvl 8 - 12", icon: Shield, color: "text-amber-400 bg-amber-400/10 border-amber-400/20" },
    { name: "Veritabanı Mimarı (Staff)", range: "Lvl 13 - 17", icon: Crown, color: "text-orange-400 bg-orange-500/10 border-orange-500/20" },
    { name: "Baş Analitik Uzmanı (Principal)", range: "Lvl 18+", icon: Sparkles, color: "text-amber-300 bg-amber-500/15 border-amber-500/30" },
  ];
  ...
  const mockLeaderboard = [
    { rank: 1, name: "selim_forensics", level: 21, xp: 5450, solved: 32, streak: 28, badge: "Baş Analitik Uzmanı (Principal)" },
    { rank: 2, name: "elif_analytics", level: 19, xp: 4890, solved: 29, streak: 19, badge: "Baş Analitik Uzmanı (Principal)" },
    { rank: 3, name: "caner_data", level: 16, xp: 4120, solved: 26, streak: 14, badge: "Veritabanı Mimarı (Staff)" },
    { rank: 4, name: "berk_db", level: 14, xp: 3600, solved: 22, streak: 11, badge: "Veritabanı Mimarı (Staff)" },
    { rank: 5, name: "zeynep_analyst", level: 11, xp: 2850, solved: 18, streak: 8, badge: "Kıdemli Veri Mühendisi (Senior)" },
  ];
      ...
      <div className="max-w-7xl mx-auto p-4 md:p-8 space-y-8">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2 text-amber-400">
              ...
              <h1 className="text-2xl md:text-3xl font-extrabold text-[#f6f3ee] tracking-tight">
                ANALİTİK LİDERLİK SIRALAMASI
              </h1>
            </div>
            <p className="text-xs md:text-sm text-[#a8a196] max-w-xl">
              SQL sorgularınızı bağımsız ve hatasız çözümleyerek analitik puanınızı artırın; kademenizi yükseltin.
            </p>
          </div>

          {/* User Active Rank Card */}
          {mounted && (
            <div className="flex items-center gap-3 bg-[#181614] border border-[#26221d] px-4 py-3 rounded-2xl">
        ...
        <div className="rounded-2xl bg-gradient-to-r from-amber-500/10 via-orange-500/10 to-amber-500/10 border border-amber-500/30 p-5 md:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-lg">
          ...
          >
            ...
            <span>Günün Senaryosunu Başlat</span>
          ...
          <div className="lg:col-span-4 space-y-4">
            <div className="p-4 rounded-2xl glass-panel border border-[#2c2823] space-y-3">
              ...
              <p className="text-xs text-[#a8a196]">
                Doğruladığınız her sorgu ile analitik puan (XP) kazanın ve kademe atlayın.
              </p>
